...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "toakrona-dns-seed\n"
...
static const string mainnet_seeds[] = {"dnsseed.toakrona.tk", ""};
static const string testnet_seeds[] = {"dnsseed.toakrona.tk", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 10442), true);
  }
  do {
